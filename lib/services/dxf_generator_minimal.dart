...
class DXFGeneratorMinimal {
  static final DXFGeneratorMinimal _instance = DXFGeneratorMinimal._internal();
  factory DXFGeneratorMinimal() => _instance;
  DXFGeneratorMinimal._internal();
  ...
  Future<String?> generateDXFFromImage(ImageData imageData) async {
    try {
      ...
      // Generate DXF file
      final fileName = 'dxf_minimal_${imageData.id}';
